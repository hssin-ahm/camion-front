...
export function getChartOptions(obj: any, data, xaxis, type?) {
  return {
    series: [
      {
        name: 'Cost(DT)',
...
export function getTotalCostChartOptions(obj: any, data, xaxis, type?) {
  return {
    series: [
      {
        name: 'Cost(DT)',
...
export function getRevenueChartOptions(obj: any) {
  return {
    series: [
      {
        name: 'Revenue',
